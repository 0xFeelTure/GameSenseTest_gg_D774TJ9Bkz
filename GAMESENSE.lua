...
local Library = {
    ...
    AccentColor = Color3.fromRGB(88, 255, 174);
    OutlineColor = Color3.fromRGB(20, 20, 20);

    Black = Color3.new(30, 30, 30);
...
Library.AccentColorDark = Library:GetDarkerColor(Color3.fromRGB(65, 149, 155));
...
do
    ...
    function Funcs:AddColorPicker(Idx, Info)
        ...
        local Highlight = Library:Create('Frame', {
            BackgroundColor3 = Color3.fromRGB(65, 149, 155);
            BorderSizePixel = 0;
    ...
    function Funcs:AddKeyPicker(Idx, Info)
        ...
        for Idx, Mode in next, Modes do
            ...
            function ModeButton:Select()
                ...
                Label.TextColor3 = Color3.fromRGB(65, 149, 155);
        ...
        function KeyPicker:Update()
            ...
            ContainerLabel.TextColor3 = State and Color3.fromRGB(65, 149, 155) or Library.FontColor;
...
do
    ...
    function Funcs:AddToggle(Idx, Info)
        ...
        function Toggle:Display()
            ToggleInner.BackgroundColor3 = Toggle.Value and Color3.fromRGB(65, 149, 155) or Library.MainColor;
            ToggleInner.BorderColor3 = Toggle.Value and Color3.fromRGB(65, 149, 155) or Library.OutlineColor;
    ...
    function Funcs:AddDropdown(Idx, Info)
        ...
        local Scrolling = Library:Create('ScrollingFrame', {
            ...
            ScrollBarImageColor3 = Color3.fromRGB(65, 149, 155), 
        });
...
do
    ...
    local WatermarkInner = Library:Create('Frame', {
        BackgroundColor3 = Library.MainColor;
        BorderColor3 = Color3.fromRGB(65, 149, 155);
        BorderMode = Enum.BorderMode.Inset;
        Size = UDim2.new(1, 0, 1, 0);
        ZIndex = 201;
...
function Library:CreateWindow(...)
    ...
    function Library.Toggle()
        ...
        while Outer.Visible and ScreenGui.Parent do
            ...
            Cursor.Color = Color3.fromRGB(65, 149, 155);
